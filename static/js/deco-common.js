...
//顶部搜索栏搜索方法
//通过搜索栏输入数据，通过js将数据包括在keywords里面，并post至正确页面中
function search_click(){
    ...
    if(type == "fandom"){
        request_url = "/fandom/list?keywords="+keywords
    }else if(type == "star"){
        request_url = "/fandom/star/list?keywords="+keywords
    }else if(type == "article"){
        request_url = "/fandom/article/list?keywords="+keywords
    }
    else if(type == "video"){
        request_url = "/fandom/video/list?keywords="+keywords
    }
    else if(type == "picture"){
        request_url = "/fandom/picture/list?keywords="+keywords
    }
